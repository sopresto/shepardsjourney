...
//this will append time, sheep, health to their respective divs.

$('#time').html(time);
$('#sheep').html(sheep);
$('#health').html(health);

//this will hide the answers div as it does not need to appear in the first scene.
$("#answerTwo").hide();
$("#answerOne").hide();
...
//*Previous verison is below in comments//
